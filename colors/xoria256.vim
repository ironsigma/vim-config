...
hi Folded	cterm=none	ctermfg=248	ctermbg=0	gui=none	guifg=#eeeeee	guibg=#5f5f87
...
hi FoldColumn	cterm=none	ctermfg=248	ctermbg=0	gui=none	guifg=#a8a8a8	guibg=bg
